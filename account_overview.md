...
GROUP BY 
	...
	wd.name
~~~
:memo: Finally we iterate over each row (looks like: `['equipment_id` equipment_type_id equipment_status_name name
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY0MTAzODE3NywtOTQyNzM0NzksLTkwNz
