...
:memo: Following SQL counts orders where `order_status_id = '3'` (i.e. 'Completed') and `o.order_type_id = '1'`
~~~sql
SELECT count(o.order_id) AS count, sum(order_total) AS value
FROM ".TABLE_ORDERS." o
WHERE
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTEwMzM1NzUxLC02OTE0MjE1MTUsLTExMz
E1MzA2NDMsMTcxMzIwNjUxMCwtMjA2NzYxOTUxNCwtMTM2NDE3
NDgwMCwtNzk0OTI1NjQyLDYxMjEyNjQ1NCwtMTg4MTUxMTM3MC
w1MTQyNDExMywyMDkzNDMxNzk0LC05NDI3MzQ3OSwtOTA3NTkw
MTU2LDIwMTA3OTcwNzAsLTczMDI1NTc5NSwyMDM0MzI2MDI5LC
03NjUzMzgyMzQsOTUyMDMxNzc2LDIwNDkxNjU1MjAsLTEwNzE2
NTAyMjhdfQ==
-->